...
# Параметры
BUNDLE_ID="com.storytable.game"
APPLE_ID="6752716048"
REMOTE_URL="git@github.com:sdeslvm/Your-story-begins-at-the-table.git"
PROJECT_NAME="Your story begins at the table"
SCHEME_NAME="Your story begins at the table"
